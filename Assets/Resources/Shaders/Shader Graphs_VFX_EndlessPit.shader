Shader "Shader Graphs/VFX_EndlessPit" {
	Properties {
		_DepthMultiplier ("DepthMultiplier", Float) = 1
		_Power ("Power", Float) = 1
		[HDR] _Emission ("Emission", Vector) = (0.1254902,0.145098,0.1607843,0)
		_Color ("Color", Vector) = (0.1254902,0.145098,0.1607843,0)
		_FadeDistance ("FadeDistance", Vector) = (0,0.2,0,0)
